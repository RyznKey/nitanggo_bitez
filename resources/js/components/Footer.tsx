            ...
            <div className="max-w-[1100px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                        ...
                        {/* Logo WhatsApp */}
                        <a href="https://wa.me/6285700655072" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 rounded-full bg-[#FDF1D5] text-[#D49800] flex items-center justify-center hover:bg-[#F8C83B] hover:text-white transition-colors shadow-sm">
