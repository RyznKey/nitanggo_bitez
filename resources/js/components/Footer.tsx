...
}} className="text-[0.9rem] text-[#796C63] no-underline transition-colors duration-300 hover:text-[#E68A00]">Beranda</a></li>
                        <li><a href="#" onClick={(e) => {
 e.preventDefault(); setCurrentView('view-menu'); 
}} className="text-[0.9rem] text-[#796C63] no-underline transition-colors duration-300 hover:text-[#E68A00]">Menu</a></li>
                    </ul>
                </div>
            ...
            <div className="max-w-[1100px] mt-[50px] mx-auto pt-6 border-t border-[#EBE3D5] flex flex-col md:flex-row justify-between items-center gap-4 text-[0.85rem] text-[#A39B94] font-medium text-center md:text-left">
                ...
                <div className="flex items-center gap-4 md:gap-6">
                    ...
                    <a href="/admin/login" className="text-[#A39B94] hover:text-[#E07A72] transition-colors no-underline border-l border-[#EBE3D5] pl-4 md:pl-6">
                        Admin Portal
                    </a>
                </div>
            </div>
